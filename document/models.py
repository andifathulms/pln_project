...
class MacroData(models.Model):
    ...
    jan_progress_fisik          = models.IntegerField(blank=True, null=True)
    jan_rencana_disburse        = models.IntegerField(blank=True, null=True)
    feb_progress_fisik          = models.IntegerField(blank=True, null=True)
    feb_rencana_disburse        = models.IntegerField(blank=True, null=True)
    mar_progress_fisik          = models.IntegerField(blank=True, null=True)
    mar_rencana_disburse        = models.IntegerField(blank=True, null=True)
    apr_progress_fisik          = models.IntegerField(blank=True, null=True)
    apr_rencana_disburse        = models.IntegerField(blank=True, null=True)
    mei_progress_fisik          = models.IntegerField(blank=True, null=True)
    mei_rencana_disburse        = models.IntegerField(blank=True, null=True)
    jun_progress_fisik          = models.IntegerField(blank=True, null=True)
    jun_rencana_disburse        = models.IntegerField(blank=True, null=True)
    jul_progress_fisik          = models.IntegerField(blank=True, null=True)
    jul_rencana_disburse        = models.IntegerField(blank=True, null=True)
    aug_progress_fisik          = models.IntegerField(blank=True, null=True)
    aug_rencana_disburse        = models.IntegerField(blank=True, null=True)
    sep_progress_fisik          = models.IntegerField(blank=True, null=True)
    sep_rencana_disburse        = models.IntegerField(blank=True, null=True)
    okt_progress_fisik          = models.IntegerField(blank=True, null=True)
    okt_rencana_disburse        = models.IntegerField(blank=True, null=True)
    nov_progress_fisik          = models.IntegerField(blank=True, null=True)
    nov_rencana_disburse        = models.IntegerField(blank=True, null=True)
    des_progress_fisik          = models.IntegerField(blank=True, null=True)
    des_rencana_disburse        = models.IntegerField(blank=True, null=True)
