...
SECRET_KEY = 'django-insecure-=d_p_8&m(t8slk=!#4))i!e7ov$16zm56!1f+gr!cfhb_g(rh^'
...
MIDDLEWARE = [
    ...
    'project1.middlewares.StatsMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'document_tags': 'document.templatetags.document_tags',
            }
        },
    },
]
